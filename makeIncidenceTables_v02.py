...
INPATH = '/Volumes/Mac HDD/Hanxin/Data/inpatients/DX_OtherThanAz/'
OUTPATH = '/Volumes/Mac HDD/Hanxin/Data/inpatients/icdTables_strats_NoAz/'
...
if __name__ == '__main__':
    ...
    poolOf_16_workers = multiprocessing.Pool(16)
