...
OUTPATH = './results_SwedenBefore1980'
...
# Frequentist's Method (all diseases ...) -------------------------------------
    ...
    df_dst_start_frequ, plotDataDict_start_frequ = sampleTraces(day_of_interest=PSEUDO_DST_START_DAYS_FROM,
    ...
    df_dst_end_frequ, plotDataDict_end_frequ = sampleTraces(day_of_interest=PSEUDO_DST_END_DAYS_FROM,
                                                            diseasesDict=COND_DICT,
                                                            correction='Autumn',
                                                            days=7,
                                                            method='Frequentist',
